  ...
  return (
    <div className="d-flex align-items-center text-muted mx-4">
      ...
      <div className="d-flex align-items-center">
        <Link
          to={"/dashboard"}
          className={`text-decoration-none px-2 rounded py-1 ${isDashboard ? "active pointer-events-none text-primary" : "text-muted breadCrumbItem"
            }`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      {breadCrumbItems.map((item, index) => {
        ...
        return (
          <div className="d-flex align-items-center mx-1" key={index}>
            <Link
              to={item.path}
              className={`text-decoration-none px-2 breadCrumbItem rounded py-1 ${isLast
